      ...
      <nav className="sticky top-0 z-50 border-b-[3px] border-zinc-900 bg-[#FFFDF8]">
        <div className="mx-auto flex h-16 max-w-4xl items-center justify-between px-4 sm:px-6">
          <span className="text-xl font-bold tracking-tight">
            <span className="text-zinc-900">Web</span>
            <span className="text-[#d31611]">2Prompt</span>
          </span>
          <a
            href="https://github.com/musaAmir/web2prompt"
            target="_blank"
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    placeholder="https://github.com/… or any website URL"
                    value={repoUrl}
